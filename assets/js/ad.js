...
addImage.addEventListener('click',()=>{
    ...
    const annonceImages = document.querySelector('#ventes_images')

    //recup le prototype des entrées data-prototype
    const prototype = annonceImages.dataset.prototype.replace(/name/g, index) // drapeau g pour indiquer que l'on va le faire plusieurs fois 
...
const updateCounter = () => {
    const count = document.querySelectorAll('#ventes_images div.form-group').length
